...
function AiFooter(){
    return(
        <>
        <nav className="absolute inset-x-0 bottom-0 px-4 py-4 bg-orange-400 sm:bg-yellow-400 md:bg-blue-950 lg:bg-green-700 xl:bg-red-600 2xl:bg-purple-900 text-white">
     <div className=''>
